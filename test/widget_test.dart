...
class _ScreenAddProductState extends State<ScreenAddProduct> {
  ...
  void addProduct() async {
    if(productController.text =="" && productController.text ==null){
    ...
    else if(descriptionController.text == "" && descriptionController.text == null){
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
    ...
    else if(qtyController.text == "" && qtyController.text == null){
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
    ...
    else if(selectedImage?.path == "" && selectedImage?.path == null){
    ...
    else if (selectedCategoryId.isNotEmpty && selectedCompanyId.isNotEmpty) {
